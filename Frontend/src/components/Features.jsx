...
const featuresData = [
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Our proven expertise and state-of-the-art deployment provide seamless professional solutions and services to its clients. We excel in delivering solutions in the broad domains of:
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="lg:col-span-2 flex justify-center">
            <div className="bg-white shadow-lg rounded-xl p-6 relative overflow-hidden hover:bg-amber-600 transition-all duration-500 ease-in-out w-full max-w-2xl">
              {/* Background Shape */}
              <div className="absolute top-0 left-0 w-full h-full text-gray-200">
                <svg viewBox="0 0 451 518" className="text-blue-950" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-4 mb-4">
                  <img src={featuresData[1].icon} alt={featuresData[1].title} className="w-12 h-12" />
                  <h2 className="text-xl font-bold text-white">{featuresData[1].title}</h2>
                </div>
                <div className="text-white mb-4 text-[18px]">{featuresData[1].description}</div>
              </div>
            </div>
          </div>
          ...
          {featuresData.map((feature, index) => {
            if (index === 1) return null; // Skip the middle card (already rendered above)
            return (
              <div
                key={feature.id}
                className="bg-white shadow-lg rounded-xl p-6 relative overflow-hidden hover:bg-amber-600 transition-all duration-500 ease-in-out"
              >
                {/* Background Shape */}
                <div className="absolute top-0 left-0 w-full h-full text-gray-200">
                  <svg viewBox="0 0 451 518" className="text-blue-950" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white mb-4 text-[18px]">{feature.description}</p>
                </div>
              </div>
            );
          })}
        ...
        <div className="text-center mt-12">
          <Link to="/project" className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
            Projects
          </Link>
        </div>
      </div>
